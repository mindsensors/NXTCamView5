...
def make():
    ...
    if sys.platform.startswith('win'):
        ...
        os.system("copy misc_files\* " + installdir+"\\bin")
        ...
        installer = glob.glob(os.path.join(builddir, "nxtcamview5-*.exe"))[0]
        ...
        if os.system("cd " + builddir + " && make dmg"):
            sys.exit("Make Failed...")
        installer = glob.glob(os.path.join(builddir, "nxtcamview5-*.dmg"))[0]
        ...
        " && make installer INSTALL_ROOT="+installdir + " IFW_PATH="+ifdir):
            sys.exit("Make Failed...")
        installer = glob.glob(os.path.join(builddir, "nxtcamview5-*.run"))[0]
