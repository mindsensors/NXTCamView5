...
bool MainWindow::init(QString *errorMessage)
{
    ...
    // DGP: the Serial Terminal and Search tool buttons:
...
void MainWindow::registerDefaultContainers()
{
    ...
    medit->menu()->menuAction()->setVisible(false); // DGP

    // Tools Menu
    ActionContainer *ac = ActionManager::createMenu(Constants::M_TOOLS);
    menubar->addMenu(ac, Constants::G_TOOLS);
    ac->menu()->setTitle(tr("&Tools"));
    ac->menu()->menuAction()->setVisible(true);
    ...
    //ac->menu()->menuAction()->setVisible(false); // DGP
}
...
void MainWindow::registerDefaultActions()
{
    ...
    /* DGP
    m_optionsAction = new QAction(tr("&OptionsXX..."), this);
