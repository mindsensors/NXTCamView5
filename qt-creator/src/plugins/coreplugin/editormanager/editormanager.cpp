...
void EditorManagerPrivate::init()
{
    ...
    // DGP
    //mfile->addAction(cmd, Constants::G_FILE_CLOSE);  // this is the Close file menu item
    ...
    // OPENMV-DIFF // cmd->setDefaultKeySequence(QKeySequence(UseMacShortcuts ? tr("Alt+Tab") : tr("Ctrl+Tab")));
    // OPENMV-DIFF // mwindow->addAction(cmd, Constants::G_WINDOW_NAVIGATE);
    ...
    // OPENMV-DIFF // cmd->setDefaultKeySequence(QKeySequence(UseMacShortcuts ? tr("Alt+Shift+Tab") : tr("Ctrl+Shift+Tab")));
    // OPENMV-DIFF // mwindow->addAction(cmd, Constants::G_WINDOW_NAVIGATE);
    ...
    // OPENMV-DIFF // cmd->setDefaultKeySequence(QKeySequence(UseMacShortcuts ? tr("Ctrl+Alt+Left") : tr("Alt+Left")));
    // OPENMV-DIFF // mwindow->addAction(cmd, Constants::G_WINDOW_NAVIGATE);
    ...
    // OPENMV-DIFF // cmd->setDefaultKeySequence(QKeySequence(UseMacShortcuts ? tr("Ctrl+Alt+Right") : tr("Alt+Right")));
    // OPENMV-DIFF // mwindow->addAction(cmd, Constants::G_WINDOW_NAVIGATE);
    ...
    // OPENMV-DIFF // cmd->setDefaultKeySequence(QKeySequence(UseMacShortcuts ? tr("Meta+E,2") : tr("Ctrl+E,2")));
    // OPENMV-DIFF // mwindow->addAction(cmd, Constants::G_WINDOW_SPLIT);
    ...
    // OPENMV-DIFF // cmd->setDefaultKeySequence(QKeySequence(UseMacShortcuts ? tr("Meta+E,3") : tr("Ctrl+E,3")));
    // OPENMV-DIFF // mwindow->addAction(cmd, Constants::G_WINDOW_SPLIT);
    ...
    // OPENMV-DIFF // cmd->setDefaultKeySequence(QKeySequence(UseMacShortcuts ? tr("Meta+E,4") : tr("Ctrl+E,4")));
    // OPENMV-DIFF // mwindow->addAction(cmd, Constants::G_WINDOW_SPLIT);
    ...
    // OPENMV-DIFF // cmd->setDefaultKeySequence(QKeySequence(UseMacShortcuts ? tr("Meta+E,0") : tr("Ctrl+E,0")));
    // OPENMV-DIFF // mwindow->addAction(cmd, Constants::G_WINDOW_SPLIT);
    ...
    // OPENMV-DIFF // cmd->setDefaultKeySequence(QKeySequence(UseMacShortcuts ? tr("Meta+E,1") : tr("Ctrl+E,1")));
    // OPENMV-DIFF // mwindow->addAction(cmd, Constants::G_WINDOW_SPLIT);
    ...
    // OPENMV-DIFF // cmd->setDefaultKeySequence(QKeySequence(UseMacShortcuts ? tr("Meta+E,i") : tr("Ctrl+E,i")));
    // OPENMV-DIFF // mwindow->addAction(cmd, Constants::G_WINDOW_SPLIT);
    ...
    // OPENMV-DIFF // cmd->setDefaultKeySequence(QKeySequence(UseMacShortcuts ? tr("Meta+E,o") : tr("Ctrl+E,o")));
    // OPENMV-DIFF // mwindow->addAction(cmd, Constants::G_WINDOW_SPLIT);
...
void EditorManagerPrivate::readSettings()
{
    ...
    if (settings->contains(QLatin1String(autoSaveEnabledKey))) {
        d->m_autoSaveEnabled = false;
        // DGP: disable autosave
...
void EditorManagerPrivate::updateWindowTitleForDocument(IDocument *document, QWidget *window)
{
    ...
    windowTitle.append(tr("NXTCamView5"));
    // DGP: remove the file name from the window title.
    //window->window()->setWindowTitle(windowTitle);
    window->window()->setWindowTitle(tr(" "));
    //window->window()->setWindowFilePath(filePath);
    window->window()->setWindowFilePath(tr("."));
