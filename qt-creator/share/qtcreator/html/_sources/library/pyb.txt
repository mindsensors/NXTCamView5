...
.. function:: hard_reset()
   ...
   Resets the pyboard or the OpenMV Cam in a manner similar to pushing the external RESET
   button.
...
.. only:: port_pyboard or port_openmvcam
    ...
    .. function:: stop()
       ...
       Put the pyboard or OpenMV Cam in a "sleeping" state.
    ...
    .. function:: standby()
       ...
       Put the pyboard or OpenMV Cam into a "deep sleep" state.
       ...
       .. only:: port_pyboard
            ...
            This reduces power consumption to less than 50 uA. To wake from this
            sleep state requires a hard reset.
